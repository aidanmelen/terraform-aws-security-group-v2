...
func TestTerraformManagedRulesExample(t *testing.T) {
	...
	// assign expected
	expectedIngress0 := fmt.Sprintf("map[cidr_blocks:[10.10.0.0/16 10.20.0.0/24] description:All protocols from_port:0 id:sgrule-1111111111 ipv6_cidr_blocks:<nil> prefix_list_ids:<nil> protocol:-1 security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:0 type:ingress]", actualSecurityGroupId)
	expectedIngress1 := fmt.Sprintf("map[cidr_blocks:<nil> description:All protocols from_port:0 id:sgrule-1111111111 ipv6_cidr_blocks:<nil> prefix_list_ids:<nil> protocol:-1 security_group_id:%s self:true source_security_group_id:<nil> timeouts:<nil> to_port:0 type:ingress]", actualSecurityGroupId)
	expectedIngress2 := fmt.Sprintf("map[cidr_blocks:<nil> description:All IPV4 ICMP from_port:0 id:sgrule-1111111111 ipv6_cidr_blocks:<nil> prefix_list_ids:<nil> protocol:icmp security_group_id:%s self:false source_security_group_id:%s timeouts:<nil> to_port:0 type:ingress]", actualSecurityGroupId, actualDataAwsSecurityGroupDefaultId)
	...
	expectedIngress4 := fmt.Sprintf("map[cidr_blocks:<nil> description:PostgreSQL from_port:5432 id:sgrule-1111111111 ipv6_cidr_blocks:[2001:db8::/64] prefix_list_ids:<nil> protocol:tcp security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:5432 type:ingress]", actualSecurityGroupId)
	expectedEgress0 := fmt.Sprintf("map[cidr_blocks:<nil> description:All protocols from_port:0 id:sgrule-1111111111 ipv6_cidr_blocks:<nil> prefix_list_ids:<nil> protocol:-1 security_group_id:%s self:true source_security_group_id:<nil> timeouts:<nil> to_port:0 type:egress]", actualSecurityGroupId)
	...
	expectedEgress3 := fmt.Sprintf("map[cidr_blocks:[10.10.0.0/16 10.20.0.0/24] description:HTTPS from_port:443 id:sgrule-1111111111 ipv6_cidr_blocks:<nil> prefix_list_ids:<nil> protocol:tcp security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:443 type:egress]", actualSecurityGroupId)
