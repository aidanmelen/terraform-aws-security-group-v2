...
func TestTerraformMatrixRulesExample(t *testing.T) {
	...
	// assign expected
	expectedIngress0 := fmt.Sprintf("map[cidr_blocks:<nil> description:matrix rules default description from_port:443 id:sgrule-1111111111 ipv6_cidr_blocks:[] prefix_list_ids:<nil> protocol:tcp security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:443 type:ingress]", actualSecurityGroupId)
	expectedIngress1 := fmt.Sprintf("map[cidr_blocks:[10.0.0.0/24] description:matrix rules default description from_port:443 id:sgrule-1111111111 ipv6_cidr_blocks:<nil> prefix_list_ids:<nil> protocol:tcp security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:443 type:ingress]", actualSecurityGroupId)
	expectedIngress2 := fmt.Sprintf("map[cidr_blocks:<nil> description:matrix rules default description from_port:443 id:sgrule-1111111111 ipv6_cidr_blocks:<nil> prefix_list_ids:[%s] protocol:tcp security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:443 type:ingress]", actualDataAwsPrefixListPrivateS3Id, actualSecurityGroupId)
	expectedIngress3 := fmt.Sprintf("map[cidr_blocks:<nil> description:matrix rules default description from_port:443 id:sgrule-1111111111 ipv6_cidr_blocks:<nil> prefix_list_ids:<nil> protocol:tcp security_group_id:%s self:false source_security_group_id:%s timeouts:<nil> to_port:443 type:ingress]", actualSecurityGroupId, actualDataAwsSecurityGroupDefaultId)
	expectedIngress4 := fmt.Sprintf("map[cidr_blocks:<nil> description:matrix rules default description from_port:443 id:sgrule-1111111111 ipv6_cidr_blocks:<nil> prefix_list_ids:<nil> protocol:tcp security_group_id:%s self:true source_security_group_id:<nil> timeouts:<nil> to_port:443 type:ingress]", actualSecurityGroupId)
	expectedIngress5 := fmt.Sprintf("map[cidr_blocks:[10.0.0.0/24] description:matrix rules default description from_port:80 id:sgrule-1111111111 ipv6_cidr_blocks:<nil> prefix_list_ids:<nil> protocol:tcp security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:80 type:ingress]", actualSecurityGroupId)
