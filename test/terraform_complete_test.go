...
func TestTerraformCompleteExample(t *testing.T) {
	...
	expectedIngress1 := fmt.Sprintf("map[cidr_blocks:<nil> description:All protocols to self from_port:0 id:sgrule-1111111111 ipv6_cidr_blocks:<nil> prefix_list_ids:<nil> protocol:-1 security_group_id:%s self:true source_security_group_id:<nil> timeouts:<nil> to_port:0 type:ingress]", actualSecurityGroupId)
	...
	expectedIngress3 := fmt.Sprintf("map[cidr_blocks:<nil> description:SSH from_port:22 id:sgrule-1111111111 ipv6_cidr_blocks:<nil> prefix_list_ids:[%s] protocol:tcp security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:22 type:ingress]", actualDataAwsPrefixListPrivateS3Id, actualSecurityGroupId)
	expectedIngress4 := fmt.Sprintf("map[cidr_blocks:[0.0.0.0/0] description:common rule example from_port:443 id:sgrule-1111111111 ipv6_cidr_blocks:[::/0] prefix_list_ids:<nil> protocol:tcp security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:443 type:ingress]", actualSecurityGroupId)
	expectedIngress5 := fmt.Sprintf("map[cidr_blocks:<nil> description:PostgreSQL from_port:5432 id:sgrule-1111111111 ipv6_cidr_blocks:[2001:db8::/64] prefix_list_ids:<nil> protocol:tcp security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:5432 type:ingress]", actualSecurityGroupId)
	expectedIngress6 := fmt.Sprintf("map[cidr_blocks:[0.0.0.0/0] description:HTTP from public from_port:80 id:sgrule-1111111111 ipv6_cidr_blocks:[::/0] prefix_list_ids:<nil> protocol:tcp security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:80 type:ingress]", actualSecurityGroupId)
	...
	expectedEgress0 := fmt.Sprintf("map[cidr_blocks:[0.0.0.0/0] description:common rule example from_port:0 id:sgrule-1111111111 ipv6_cidr_blocks:[::/0] prefix_list_ids:<nil> protocol:-1 security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:0 type:egress]", actualSecurityGroupId)
	...
	expectedEgress2 := fmt.Sprintf("map[cidr_blocks:<nil> description:SSH from_port:22 id:sgrule-1111111111 ipv6_cidr_blocks:<nil> prefix_list_ids:[%s] protocol:tcp security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:22 type:egress]", actualDataAwsPrefixListPrivateS3Id, actualSecurityGroupId)
	expectedEgress3 := fmt.Sprintf("map[cidr_blocks:[10.10.0.0/16 10.20.0.0/24] description:managed rule example from_port:443 id:sgrule-1111111111 ipv6_cidr_blocks:<nil> prefix_list_ids:<nil> protocol:tcp security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:443 type:egress]", actualSecurityGroupId)
	expectedEgress4 := fmt.Sprintf("map[cidr_blocks:<nil> description:PostgreSQL from_port:5432 id:sgrule-1111111111 ipv6_cidr_blocks:[2001:db8::/64] prefix_list_ids:<nil> protocol:tcp security_group_id:%s self:false source_security_group_id:<nil> timeouts:<nil> to_port:5432 type:egress]", actualSecurityGroupId)
