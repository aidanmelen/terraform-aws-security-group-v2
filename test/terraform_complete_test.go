...
func TestTerraformCompleteExample(t *testing.T) {
	...
	expectedIngressRuleKeys := "[ingress-all-all-all-from-self ingress-icmp-all-all-from-sg-b551fece]"
	expectedEgressRuleKeys := "[egress-all-all-all-to-self egress-icmp-all-all-to-sg-b551fece]"
